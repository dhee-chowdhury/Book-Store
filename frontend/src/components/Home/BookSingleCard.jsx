...
const BookSingleCard = ({ book }) => {
  ...
  return (
    <div className="border-gray-500 border-2 rounded-lg px-4 py-2 relative hover:shadow-lg">
      ...
      <div className="flex justify-between items-center gap-x-2 mt-4 p-4">
        <BiShow
          ...
          className="text-3xl text-blue-500 hover:text-blue-800 cursor-pointer"
        />
